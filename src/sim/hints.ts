...
const HINTS: HintDef[] = [
  ...
  { id: 'tired', test: (g) => g.player.needs.energy < 35, text: 'You are tired. Sleep (Z) restores you. A shelter, a sleeping bag and a nearby fire make for better rest. At night you sleep through until first light.' },
